        ...
        <Box direction='row' pad='large'>
          <Box basis='1/2'>
            ...
            <Paragraph style={{ lineHeight: '1.8em' }}>
              ...
              of programming languages; therefore, whether your snippet is a small
              function that you use from time to time or a whole design pattern
              that you need to remember, Snippet Store got you covered.
            </Paragraph>
            <Paragraph>
                <Button
                  icon={<Download />}
